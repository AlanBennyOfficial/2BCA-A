...
image_icon = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\logo1.png")
root.iconphoto(False, image_icon)  # Logo of the window
# Buttons
play_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\play.png")  # Play button
Button(root, image=play_button, bg="#333333", bd=0, command=play_song).place(
    x=200, y=400
)
stop_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\stop.png")  # Stop Button
Button(root, image=stop_button, bg="#333333", bd=0, command=mixer.music.stop).place(
    x=300, y=400
)
resume_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\resume.png")  # Resume Button
Button(
    root, image=resume_button, bg="#333333", bd=0, command=mixer.music.unpause
).place(x=400, y=400)
pause_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\pause.png")  # Pause Button
...
logo_img = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\logo.png")  # Logo on the application console
...
image = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\openfolder.png")  # Open folder icon
...
next_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\next.png")
...
previous_button = PhotoImage(file=r"C:\Users\Dell\source\repos\Python2025\MusicPLayer\CircularAudioFlow-MusicPlayer\Icons\prev.png")
Button(
